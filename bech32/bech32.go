// NOTE This is not necessarily a standard implementation of
// bech32. This is only being exposed to allow working with
// cardano-wallet.
//
...
func Encode(hrp string, data []byte) (string, error) {
	...
	// Not validating the human readable part's length as this
	// function will be used to bech32 encode wallet xpubs for use
	// with cardano-wallet. See this issue about the
	// doubly-encoded requirement for cardano-wallet:
	// https://github.com/cardano-foundation/cardano-wallet/issues/4886
